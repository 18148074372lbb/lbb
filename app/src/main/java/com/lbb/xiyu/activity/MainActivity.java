...
import com.lbb.xiyu.fragment.MineFragment;
import com.lbb.xiyu.fragment.OrderFragment;
import com.lbb.xiyu.fragment.shebeiFragment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        mhomeFragment = mFragmentManager.findFragmentByTag("mhome_fragment");
    ...
    private void setFragment(int fragment_id) {
        ...
        switch (fragment_id){
            ...
            case FRAGMENT_HOME:
                ...
                mTabHome.setCompoundDrawablesWithIntrinsicBounds(0,
                        R.mipmap.shebei2,0,0);
                //显示对应Fragment
                if(mhomeFragment == null){
                    mhomeFragment = new shebeiFragment();
            ...
            case FRAGMENT_RANK:
                ...
                mTabRanking.setCompoundDrawablesWithIntrinsicBounds(0,
                        R.mipmap.dingdan2,0,0);
                if(mrankFragment == null){
                    mrankFragment = new OrderFragment();
